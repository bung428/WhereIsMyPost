    ...
    protected void deliverAndDrawFrame(CvCameraViewFrame frame) {
        ...
        if (modified != null) {
            try {
                ...
                Log.d("카메라", mCacheBitmap.getWidth()+"/"+mCacheBitmap.getHeight());
                Log.d("카메라", modified.width()+"/"+modified.height());
...
////            Bitmap bitmap = Bitmap.createScaledBitmap(mCacheBitmap, canvas.getHeight(), canvjas.getWidth(),  false);
//            if (canvas != null) {
//                canvas.drawColor(0, android.graphics.PorterDuff.Mode.CLEAR);
